...
function LoadBasic() {
    ...
    $(document).ready(function () {
        ...
        $('.datepickerAll').datepicker({ dateFormat: 'dd/mm/yy', changeYear: true, changeMonth: true });
        $('.datepickerAll').blur(function (e) {
            try {
...
//        PopOverError(id, 'top', 'Please enter a valid email address');
//        $(id).focus();
//        return false;
//    }
//    else {
