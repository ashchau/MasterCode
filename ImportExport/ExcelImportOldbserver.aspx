<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExcelImportOldbserver.aspx.cs" Inherits="ImportExport_ExcelImportOldbserver" %>
    ...
    <form id="form1" runat="server">
      <div class="container py-3">  
            ...
            <div class="card">  
                ...
                <div class="card-body">  
                    <button style="margin-bottom:10px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" data-backdrop="static">  
                                            ...
                                            <div class="form-group">  
                                                ...
                                                <div class="input-group">  
                                                    ...
                                                    <div class="input-group-append">  
                                                        ...
                                                        <asp:Button ID="btnupload2" runat="server" CssClass="btn btn-outline-primary" Text="Impor tExcel" OnClick="btnupload2_Click" />
                                                        <asp:Button ID="btnupload3" runat="server" CssClass="btn btn-outline-primary" Text="New Upload3" OnClick="btnupload3_Click" />
                                                    </div>  
                                                </div>  
